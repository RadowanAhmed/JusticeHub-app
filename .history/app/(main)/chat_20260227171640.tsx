...
const OPENROUTER_MODEL = "meta-llama/llama-4-maverick:free"; // ✅ Working as of Feb 2026

// Phone number for calling
const SUPPORT_PHONE_NUMBER = "+966123456789";
  ...
  const getAIResponse = async (userQuestion: string): Promise<string> => {
    ...
    try {
      ...
      const response = await fetch(OPENROUTER_API_URL, {
        ...
        body: JSON.stringify({
          model: OPENROUTER_MODEL, // Use the constant instead of hardcoded string
          messages: [
            {
              role: "system",
