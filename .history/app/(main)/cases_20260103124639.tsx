...
export default function CasesScreen() {
  ...
  const checkEnvironment = () => {
    ...
    const isExpo = window.location?.href?.includes('exp.host') || 
    ...
    try {
      ...
      if (error) {
        ...
        if (error.code === '42501') {
          Alert.alert(
            'ملاحظة',
            'جارٍ تهيئة النظام. يتم عرض بيانات تجريبية.',
            [{ text: 'حسناً' }]
          );
      ...
      Alert.alert(
        'ملاحظة',
        'جارٍ تحميل النظام. يتم عرض بيانات تجريبية.',
        [{ text: 'حسناً' }]
      );
    } finally {
      setLoading(false);
  ...
  const getSampleCases = (userId: string): Case[] => {
      ...
      >
        ...
        <View style={styles.statsContainer}>
          ...
          >
            <View style={[styles.statIcon, { backgroundColor: `${colors.primary}20` }]}>
              <MaterialIcons name="briefcase" size={20} color={colors.primary} />
            </View>
        ...
        <View style={styles.filtersContainer}>
          ...
          >
            <Ionicons 
              name="play-circle" 
              size={16} 
              color={filter === 'active' ? colors.white : colors.success} 
            />
            <Text style={[
              styles.filterText,
          ...
          >
            <Ionicons 
              name="time" 
              size={16} 
              color={filter === 'pending' ? colors.white : colors.warning} 
            />
            <Text style={[
              styles.filterText,
          ...
          >
            <Ionicons 
              ...
              size={16} 
              color={filter === 'completed' ? colors.white : colors.primary} 
            />
            <Text style={[
              styles.filterText,
        ...
        <View style={styles.casesSection}>
          ...
          {filteredCases.length === 0 ? (
            <View style={styles.emptyState}>
              <MaterialCommunityIcons name="briefcase-off" size={48} color={colors.textMuted} />
              <Text style={styles.emptyTitle}>
                {filter === 'all' ? 'لا توجد قضايا' : `لا توجد قضايا بحالة "${getStatusText(filter)}"`}
              </Text>
                    ...
                    <View style={styles.caseInfo}>
                      ...
                      <View style={styles.caseMeta}>
                        <View style={styles.categoryBadge}>
                          <MaterialIcons name="category" size={12} color={colors.textMuted} />
                        ...
                        {caseItem.court_type && (
                          <View style={styles.courtBadge}>
                            ...
                            <Text style={styles.courtText}>{caseItem.court_type}</Text>
                          </View>
                        )}
                      </View>
                    </View>
                  ...
                  <View style={styles.caseFooter}>
                    ...
                    <View style={styles.caseActions}>
                      <View style={styles.lastUpdateContainer}>
                        ...
                        <Text style={styles.lastUpdate}>آخر تحديث: {formatDate(caseItem.updated_at)}</Text>
                      </View>
                      <TouchableOpacity
          ...
          <View style={styles.helpCard}>
            ...
            <View style={styles.helpContent}>
              ...
              <Text style={styles.helpText}>
                فريق Orient Team متاح دائماً للإجابة على استفساراتك وتقديم الدعم القانوني
              </Text>
              <TouchableOpacity
        ...
        {isExpoGo && (
          <View style={styles.environmentNotice}>
            ...
            <Text style={styles.environmentText}>وضع التجربة - بيانات تجريبية</Text>
          </View>
        )}
      </ScrollView>
    </SafeAreaView>
