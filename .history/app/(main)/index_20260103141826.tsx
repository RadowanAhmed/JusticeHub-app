// apps/mobile/app/(main)/index.tsx (HomeScreen)
...
const HomeScreen = () => {
  ...
  const renderIcon = (icon: string, type: string = 'ionicons', color: string = COLORS.white, size: number = 20) => {
    switch (type) {
      case 'material':
          ...
          <View style={styles.statsContainer}>
            {STATS_CONFIG.map((stat, index) => (
              <TouchableOpacity
                ...
                activeOpacity={0.7}
                onPress={() => {
                  if (stat.key === 'cases' || stat.key === 'activeCases') router.push('/(main)/cases');
...
>
  <View style={styles.aiBannerContent}>
    <View style={styles.aiIconContainer}>
      <MaterialIcons name="gavel" size={28} color={COLORS.textWhite} />
    </View>
    <View style={styles.aiTextContainer}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center' }}>
        <Text style={styles.aiDescription}>{t('home.support.subtitle')}</Text>
      </View>
    </View>
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 4 }}>
    <Ionicons name="hand-left-outline" size={12} color={COLORS.textWhite} style={{ marginRight: 4 }} />
    <Text style={styles.aiActionText}>{t('home.support.tapToStart')}</Text>
  </View>
</LinearGradient>
        </TouchableOpacity>
            ...
            {ACTIVITY_ITEMS.map((activity) => (
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  if (activity.type === 'document') router.push('/(main)/documents');
                }}
              >
