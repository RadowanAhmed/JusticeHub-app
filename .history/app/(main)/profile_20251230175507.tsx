...
const ProfileScreen = () => {
  ...
  const fetchStats = async () => {
    ...
    try {
      const [casesResult, conversationsResult, documentsResult, appointmentsResult] = await Promise.all([
        ...
        supabase.from('legal_documents').select('*', { count: 'exact', head: true }).eq('user_id', user.id),
  ...
  const handleImagePick = async () => {
    try {
      ...
      if (status !== 'granted') {
        Alert.alert(
          t('common.error'),
          t('profile.permissionDenied', 'Permission to access photos is required')
        );
        return;
      }
  ...
  const styles = StyleSheet.create({
    ...
    statIcon: {
      ...
      alignItems: 'center',
      marginBottom: 8,
      backgroundColor: isDarkMode ? '#3b82f620' : '#3b82f615',
    },
    statValue: {
      fontSize: 20,
      fontWeight: 'bold',
    ...
    verifyBadge: {
      ...
      borderRadius: 12,
      borderWidth: 1,
      borderColor: isDarkMode ? '#10b98140' : '#10b98120',
    },
    verifyText: {
      fontSize: 11,
      color: colors.success,
    ...
    settingIcon: {
      ...
      alignItems: 'center',
      marginRight: 16,
      backgroundColor: isDarkMode ? '#f59e0b20' : '#f59e0b15',
    },
    settingText: {
      flex: 1,
    },
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.profileHeader}>
          <View style={styles.profileImageContainer}>
            <Image
              source={{ 
                uri: profile?.avatar_url || `https://ui-avatars.com/api/?name=${encodeURIComponent(getUserFullName())}&background=${colors.primary.replace('#', '')}&color=ffffff&size=128`
              }}
          ...
          <View style={styles.ratingBadge}>
            ...
            <Text style={styles.ratingText}>4.8 • {t('profile.memberSince')} 2024</Text>
          </View>
          ...
          <View style={styles.completionContainer}>
            ...
            <Text style={styles.completionHint}>
              {completionPercentage < 100 
                ? t('profile.completeProfileHint', 'أكمل ملفك الشخصي للحصول على تجربة أفضل')
        ...
        <View style={styles.statsContainer}>
          ...
          <View style={styles.statItem}>
            <View style={[styles.statIcon, { backgroundColor: isDarkMode ? '#f59e0b20' : '#f59e0b15' }]}>
              <Feather name="message-square" size={20} color={colors.warning} />
            </View>
            <Text style={styles.statValue}>{stats.consultations}</Text>
            <Text style={styles.statLabel}>{t('profile.stats.consultations')}</Text>
          </View>
          <View style={styles.statDivider} />
          <View style={styles.statItem}>
            <View style={[styles.statIcon, { backgroundColor: isDarkMode ? '#10b98120' : '#10b98115' }]}>
          ...
          <View style={styles.statDivider} />
          <View style={styles.statItem}>
            <View style={[styles.statIcon, { backgroundColor: isDarkMode ? '#0ea5e920' : '#0ea5e915' }]}>
              <Feather name="calendar" size={20} color={colors.info} />
            </View>
            <Text style={styles.statValue}>{stats.appointments}</Text>
            <Text style={styles.statLabel}>{t('home.stats.upcomingAppointments')}</Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.settingsCard}>
            ...
            <View style={styles.settingItem}>
              <View style={styles.settingInfo}>
                <View style={[styles.settingIcon, { backgroundColor: isDarkMode ? '#8b5cf620' : '#8b5cf615' }]}>
            ...
            <View style={styles.settingItem}>
              <View style={styles.settingInfo}>
                <View style={[styles.settingIcon, { backgroundColor: isDarkMode ? `${colors.primary}20` : `${colors.primary}15` }]}>
            ...
            {menuItems.map((item) => (
              ...
              >
                <View style={styles.menuItemLeft}>
                  <View style={[styles.menuIcon, { backgroundColor: isDarkMode ? `${item.color}20` : `${item.color}15` }]}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.actionsCard}>
            <TouchableOpacity style={styles.actionButton} onPress={() => {}}>
              <View style={[styles.actionIcon, { backgroundColor: isDarkMode ? '#3b82f620' : '#3b82f615' }]}>
            ...
            <TouchableOpacity style={styles.actionButton} onPress={() => {}}>
              <View style={[styles.actionIcon, { backgroundColor: isDarkMode ? '#ef444420' : '#ef444415' }]}>
        ...
        <View style={styles.versionContainer}>
          <Image
            source={{ uri: `https://ui-avatars.com/api/?name=ORIENT&background=${colors.primary.replace('#', '')}&color=ffffff&size=64` }}
            style={styles.logo}
          />
          <Text style={styles.appName}>ORIENT</Text>
          <Text style={styles.versionText}>v1.0.0</Text>
          <Text style={styles.copyrightText}>© 2024 Orient. {t('splash.allRightsReserved')}</Text>
        </View>
      </ScrollView>
          ...
          <View style={styles.modalContainer}>
            ...
            <ScrollView style={styles.modalContent} showsVerticalScrollIndicator={false}>
              <Text style={styles.modalSectionTitle}>
                <Feather name="user" size={16} color={colors.primary} /> {t('profile.personalInfo')}
              </Text>
              ...
              <Text style={styles.modalSectionTitle}>
                <Feather name="map-pin" size={16} color={colors.success} /> {t('profile.addressInfo')}
              </Text>
              ...
              <Text style={styles.modalSectionTitle}>
                <Feather name="info" size={16} color={colors.accent} /> {t('profile.aboutYou')}
              </Text>
              ...
              <View style={styles.formGroup}>
                ...
                <View style={styles.genderOptions}>
                  ...
                  >
                    <Feather name="user" size={16} color={formData.gender === 'male' ? colors.textInverse : colors.textSecondary} />
                    <Text style={[
                      styles.genderText,
                  ...
                  >
                    <Feather name="user" size={16} color={formData.gender === 'female' ? colors.textInverse : colors.textSecondary} />
                    <Text style={[
                      styles.genderText,
