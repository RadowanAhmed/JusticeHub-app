...
export default function LoginScreen() {
  ...
  try {
    ...
    if (status !== 'granted') {
      ...
      if (newStatus !== 'granted') {
        Alert.alert(
          "الإشعارات مطلوبة",
          "الرجاء تمكين الإشعارات من إعدادات الهاتف لاستخدام هذه الميزة"
        );
        return;
      }
    }
    ...
    Alert.alert("نجاح", "تم إرسال الإشعار التجريبي!");
  } catch (error) {
  ...
  >
    <Text style={{ color: colors.textInverse, fontSize: 14 }}>
      🧪 اختبار الإشعارات الآن
    </Text>
  </TouchableOpacity>
</View>
      <ErrorModal />
